...
exports.getAllPerons = async (req, res) => {
	try{
		const json = await personService.person.getAllPersons();
...
exports.getPersonById = async (req, res) => {
	try{
		...
		const json = await personService.person.findPersonById(req);
...
exports.updateAvatar = async (req, res) => {
	try{
		...
		const data = await personService.person.updateAvatar(req);
		res.json(data).status(StatusCodes.CREATED);
...
exports.updateCv = async (req, res) => {
	try{
		...
		const data = await personService.person.updateCv(req);
		res.json(data).status(StatusCodes.CREATED);
