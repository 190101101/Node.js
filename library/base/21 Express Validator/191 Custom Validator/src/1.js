...
router.post('/create', validateUser.validateUser(), (req, res) => {
...
router.get('/user/:userid', validateUser.getUserById(), (req, res) => {
	const errors = validationResult(req);
	console.log(errors.array());
	res.send('ok');
});

router.get('/query', validateUser.validateQuery(), (req, res) => {
	const errors = validationResult(req);
	console.log(errors.array());
	res.send('ok');
});
